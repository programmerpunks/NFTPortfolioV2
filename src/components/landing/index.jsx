    ...
    <>
      <div className="flex w-full bg-moon-img bg-no-repeat bg-center bg-contain  justify-center text-white ">
        <div className="flex flex-col pt-[10%] justify-center">
          <div className="flex text-6xl md:text-8xl justify-center">
            To The Moon!
          </div>
          ...
          <div className="flex justify-evenly w-full p-5 flex-col md:flex-row">
            ...
            <button className="flex p-4 mt-2 md:mt-0 px-14 text-black justify-center rounded-xl bg-yellow-400  hover:scale-110 duration-500">
              Enter game
            </button>
          </div>
